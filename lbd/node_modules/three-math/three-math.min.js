...
e=d[0],g=d[4],f=d[8],h=d[1],i=d[5],j=d[9],k=d[2],l=d[6],d=d[10];void 0===b||"XYZ"===b?(this.y=Math.asin(c(f)),0.99999>Math.abs(f)?(this.x=Math.atan2(-j,d),this.z=Math.atan2(-g,e)):(this.x=Math.atan2(l,i),this.z=0)):"YXZ"===b?(this.x=Math.asin(-c(j)),0.99999>Math.abs(j)?(this.y=Math.atan2(f,d),this.z=Math.atan2(h,i)):(this.y=Math.atan2(-k,e),this.z=0)):"ZXY"===b?(this.x=Math.asin(c(l)),0.99999>Math.abs(l)?(this.y=Math.atan2(-k,d),this.z=Math.atan2(-g,i)):(this.y=0,this.z=Math.atan2(h,e))):"ZYX"===
b?(this.y=Math.asin(-c(k)),0.99999>Math.abs(k)?(this.x=Math.atan2(l,d),this.z=Math.atan2(h,e)):(this.x=0,this.z=Math.atan2(-g,i))):"YZX"===b?(this.z=Math.asin(c(h)),0.99999>Math.abs(h)?(this.x=Math.atan2(-j,i),this.y=Math.atan2(-k,e)):(this.x=0,this.y=Math.atan2(f,d))):"XZY"===b&&(this.z=Math.asin(-c(g)),0.99999>Math.abs(g)?(this.x=Math.atan2(l,i),this.y=Math.atan2(f,e)):(this.x=Math.atan2(-j,d),this.y=0));return this},setEulerFromQuaternion:function(a,b){function c(a){return Math.min(Math.max(a,
...
this.x&&a.y===this.y&&a.z===this.z&&a.w===this.w},clone:function(){return new THREE.Vector4(this.x,this.y,this.z,this.w)},setAxisAngleFromQuaternion:function(a){this.w=2*Math.acos(a.w);var b=Math.sqrt(1-a.w*a.w);1E-4>b?(this.x=1,this.z=this.y=0):(this.x=a.x/b,this.y=a.y/b,this.z=a.z/b);return this},setAxisAngleFromRotationMatrix:function(a){var b,c,d,a=a.elements,e=a[0];d=a[4];var g=a[8],f=a[1],h=a[5],i=a[9];c=a[2];b=a[6];var j=a[10];if(0.01>Math.abs(d-f)&&0.01>Math.abs(g-c)&&0.01>Math.abs(i-b)){if(0.1>
Math.abs(d+f)&&0.1>Math.abs(g+c)&&0.1>Math.abs(i+b)&&0.1>Math.abs(e+h+j-3))return this.set(1,0,0,0),this;a=Math.PI;e=(e+1)/2;h=(h+1)/2;j=(j+1)/2;d=(d+f)/4;g=(g+c)/4;i=(i+b)/4;e>h&&e>j?0.01>e?(b=0,d=c=0.707106781):(b=Math.sqrt(e),c=d/b,d=g/b):h>j?0.01>h?(b=0.707106781,c=0,d=0.707106781):(c=Math.sqrt(h),b=d/c,d=i/c):0.01>j?(c=b=0.707106781,d=0):(d=Math.sqrt(j),b=g/d,c=i/d);this.set(b,c,d,a);return this}a=Math.sqrt((b-i)*(b-i)+(g-c)*(g-c)+(f-d)*(f-d));0.0010>Math.abs(a)&&(a=1);this.x=(b-i)/a;this.y=
(g-c)/a;this.z=(f-d)/a;this.w=Math.acos((e+h+j-1)/2);return this}};THREE.Box2=function(a,b){this.min=void 0!==a?a:new THREE.Vector2(Infinity,Infinity);this.max=void 0!==b?b:new THREE.Vector2(-Infinity,-Infinity)};
...
transpose:function(){var a,b=this.elements;a=b[1];b[1]=b[3];b[3]=a;a=b[2];b[2]=b[6];b[6]=a;a=b[5];b[5]=b[7];b[7]=a;return this},transposeIntoArray:function(a){var b=this.elements;a[0]=b[0];a[1]=b[3];a[2]=b[6];a[3]=b[1];a[4]=b[4];a[5]=b[7];a[6]=b[2];a[7]=b[5];a[8]=b[8];return this},clone:function(){var a=this.elements;return new THREE.Matrix3(a[0],a[3],a[6],a[1],a[4],a[7],a[2],a[5],a[8])}};THREE.Matrix3.__v1=new THREE.Vector3;THREE.Matrix4=function(a,b,c,d,e,g,f,h,i,j,k,l,m,p,q,r){this.elements=new Float32Array(16);this.set(void 0!==a?a:1,b||0,c||0,d||0,e||0,void 0!==g?g:1,f||0,h||0,i||0,j||0,void 0!==k?k:1,l||0,m||0,p||0,q||0,void 0!==r?r:1)};
...
b[0]=a[0]*d;b[1]=a[1]*d;b[2]=a[2]*d;b[4]=a[4]*e;b[5]=a[5]*e;b[6]=a[6]*e;b[8]=a[8]*c;b[9]=a[9]*c;b[10]=a[10]*c;return this},translate:function(a){var b=this.elements,c=a.x,d=a.y,a=a.z;b[12]=b[0]*c+b[4]*d+b[8]*a+b[12];b[13]=b[1]*c+b[5]*d+b[9]*a+b[13];b[14]=b[2]*c+b[6]*d+b[10]*a+b[14];b[15]=b[3]*c+b[7]*d+b[11]*a+b[15];return this},rotateX:function(a){var b=this.elements,c=b[4],d=b[5],e=b[6],g=b[7],f=b[8],h=b[9],i=b[10],j=b[11],k=Math.cos(a),a=Math.sin(a);b[4]=k*c+a*f;b[5]=k*d+a*h;b[6]=k*e+a*i;b[7]=k*
g+a*j;b[8]=k*f-a*c;b[9]=k*h-a*d;b[10]=k*i-a*e;b[11]=k*j-a*g;return this},rotateY:function(a){var b=this.elements,c=b[0],d=b[1],e=b[2],g=b[3],f=b[8],h=b[9],i=b[10],j=b[11],k=Math.cos(a),a=Math.sin(a);b[0]=k*c-a*f;b[1]=k*d-a*h;b[2]=k*e-a*i;b[3]=k*g-a*j;b[8]=k*f+a*c;b[9]=k*h+a*d;b[10]=k*i+a*e;b[11]=k*j+a*g;return this},rotateZ:function(a){var b=this.elements,c=b[0],d=b[1],e=b[2],g=b[3],f=b[4],h=b[5],i=b[6],j=b[7],k=Math.cos(a),a=Math.sin(a);b[0]=k*c+a*f;b[1]=k*d+a*h;b[2]=k*e+a*i;b[3]=k*g+a*j;b[4]=k*
f-a*c;b[5]=k*h-a*d;b[6]=k*i-a*e;b[7]=k*j-a*g;return this},rotateByAxis:function(a,b){var c=this.elements;if(1===a.x&&0===a.y&&0===a.z)return this.rotateX(b);if(0===a.x&&1===a.y&&0===a.z)return this.rotateY(b);if(0===a.x&&0===a.y&&1===a.z)return this.rotateZ(b);var d=a.x,e=a.y,g=a.z,f=Math.sqrt(d*d+e*e+g*g),d=d/f,e=e/f,g=g/f,f=d*d,h=e*e,i=g*g,j=Math.cos(b),k=Math.sin(b),l=1-j,m=d*e*l,p=d*g*l,l=e*g*l,d=d*k,q=e*k,k=g*k,g=f+(1-f)*j,f=m+k,e=p-q,m=m-k,h=h+(1-h)*j,k=l+d,p=p+q,l=l-d,i=i+(1-i)*j,j=c[0],d=
c[1],q=c[2],r=c[3],n=c[4],s=c[5],t=c[6],u=c[7],v=c[8],w=c[9],x=c[10],y=c[11];c[0]=g*j+f*n+e*v;c[1]=g*d+f*s+e*w;c[2]=g*q+f*t+e*x;c[3]=g*r+f*u+e*y;c[4]=m*j+h*n+k*v;c[5]=m*d+h*s+k*w;c[6]=m*q+h*t+k*x;c[7]=m*r+h*u+k*y;c[8]=p*j+l*n+i*v;c[9]=p*d+l*s+i*w;c[10]=p*q+l*t+i*x;c[11]=p*r+l*u+i*y;return this},scale:function(a){var b=this.elements,c=a.x,d=a.y,a=a.z;b[0]*=c;b[4]*=d;b[8]*=a;b[1]*=c;b[5]*=d;b[9]*=a;b[2]*=c;b[6]*=d;b[10]*=a;b[3]*=c;b[7]*=d;b[11]*=a;return this},getMaxScaleOnAxis:function(){var a=this.elements;
...
THREE.Ray.__v1=new THREE.Vector3;THREE.Ray.__v2=new THREE.Vector3;THREE.Frustum=function(a,b,c,d,e,g){this.planes=[void 0!==a?a:new THREE.Plane,void 0!==b?b:new THREE.Plane,void 0!==c?c:new THREE.Plane,void 0!==d?d:new THREE.Plane,void 0!==e?e:new THREE.Plane,void 0!==g?g:new THREE.Plane]};
THREE.Frustum.prototype={set:function(a,b,c,d,e,g){var f=this.planes;f[0].copy(a);f[1].copy(b);f[2].copy(c);f[3].copy(d);f[4].copy(e);f[5].copy(g);return this},copy:function(a){for(var b=this.planes,c=0;6>c;c++)b[c].copy(a.planes[c]);return this},setFromMatrix:function(a){var b=this.planes,c=a.elements,a=c[0],d=c[1],e=c[2],g=c[3],f=c[4],h=c[5],i=c[6],j=c[7],k=c[8],l=c[9],m=c[10],p=c[11],q=c[12],r=c[13],n=c[14],c=c[15];b[0].setComponents(g-a,j-f,p-k,c-q).normalize();b[1].setComponents(g+a,j+f,p+k,
c+q).normalize();b[2].setComponents(g+d,j+h,p+l,c+r).normalize();b[3].setComponents(g-d,j-h,p-l,c-r).normalize();b[4].setComponents(g-e,j-i,p-m,c-n).normalize();b[5].setComponents(g+e,j+i,p+m,c+n).normalize();return this},intersectsObject:function(a){for(var b=a.matrixWorld,c=this.planes,d=b.getPosition(),a=-a.geometry.boundingSphere.radius*b.getMaxScaleOnAxis(),b=0;6>b;b++)if(c[b].distanceToPoint(d)<a)return!1;return!0},intersectsSphere:function(a){for(var b=this.planes,c=a.center,a=-a.radius,d=
...
THREE.Plane.__v1=new THREE.Vector3;THREE.Plane.__v2=new THREE.Vector3;THREE.Sphere=function(a,b){this.center=void 0!==a?a:new THREE.Vector3;this.radius=void 0!==b?b:0};
...
clone:function(){return(new THREE.Triangle).copy(this)}};THREE.Triangle.__v0=new THREE.Vector3;THREE.Triangle.__v1=new THREE.Vector3;THREE.Triangle.__v2=new THREE.Vector3;THREE.Triangle.__v3=new THREE.Vector3;
